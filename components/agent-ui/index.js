        ...
        success: (res) => {
          ...
          if (!secondRatingShown) {
            ...
            if (this.data.chatModel === 'professional') {
              wmsg = '亲爱的妈妈，欢迎来到我们的健康小助手服务！\n\n' + 
                     '感谢你分享你的感受。我是你专属的健康小助手，<span style="color: red;"><strong>以专业医生的身份为你提供支持。</strong></span>你可以：\n\n' + 
                     ' 向小助手倾诉你的担忧与压力，表达你的情绪与想法。\n\n' + 
                     ' 提出你在育儿过程中遇到的具体问题或困惑。\n\n' + 
                     ' 询问与健康、情感支持或日常护理相关的建议。\n\n' + 
                     '我们的小助手会根据你的感受和需求，提供更贴合你情况的个性化帮助。希望能为你带来更多的支持与安慰。\n\n' +
                     '本次是一个简短的小实验，你将与我们的健康小助手进行约8分钟的交流。请尽量保持互动，直到页面自动跳转，随后你将填写一个简单的感受问卷，完成后即可领取一个小红包（价值约10元）。非常感谢你的参与与支持！\n\n' +
                     '现在，让我们开始对话吧！';
            } else if (this.data.chatModel === 'gentle') {
              wmsg = '亲爱的妈妈，欢迎来到我们的健康小助手服务！\n\n' + 
                     '感谢你分享你的感受。我是你专属的健康小助手，<span style="color: red;"><strong>以朋友的身份为你提供支持。</strong></span>你可以：\n\n' + 
                     ' 向小助手倾诉你的担忧与压力，表达你的情绪与想法。\n\n' + 
                     ' 提出你在育儿过程中遇到的具体问题或困惑。\n\n' + 
                     ' 询问与健康、情感支持或日常护理相关的建议。\n\n' + 
                     '我们的小助手会根据你的感受和需求，提供更贴合你情况的个性化帮助。希望能为你带来更多的支持与安慰。\n\n' +
              ...
              wmsg = '亲爱的妈妈，欢迎来到我们的健康小助手服务！\n\n' + 
                     this.data.customWelcomeMessage + 
                     '\n\n现在，让我们开始对话吧！';
            }
            // 添加欢迎消息到聊天记录
            const welcomeMessage = {
