        ...
        success: (res) => {
          ...
          if (!secondRatingShown) {
            ...
            if (this.data.chatModel == 'professional'){
              wmsg = '感谢你分享你的感受。我是你专属的健康小助手，<span style="color: red;"><strong>以专业医生的身份为你提供支持。</strong></span>你可以：\n\n 向小助手倾诉你的担忧与压力，表达你的情绪与想法。\n\n 提出你在育儿过程中遇到的具体问题或困惑。\n\n 询问与健康、情感支持或日常护理相关的建议。\n\n我们的小助手会根据你的感受和需求，提供更贴合你情况的个性化帮助。希望能为你带来更多的支持与安慰'
            } else if (this.data.chatModel == 'gentle') {
              wmsg = '感谢你分享你的感受。我是你专属的健康小助手，<span style="color: red;"><strong>以朋友的身份为你提供支持。</strong></span>你可以：\n\n 向小助手倾诉你的担忧与压力，表达你的情绪与想法。\n\n 提出你在育儿过程中遇到的具体问题或困惑。\n\n 询问与健康、情感支持或日常护理相关的建议。\n\n我们的小助手会根据你的感受和需求，提供更贴合你情况的个性化帮助。希望能为你带来更多的支持与安慰';
            } else {
